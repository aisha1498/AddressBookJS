...
class Person{
    ...
    //uc11 - method to return everything in string
    toString(){
        return `First Name: ${this.firstName}\nLast Name: ${this.lastName}\nAddress: ${this.address}\nCity: ${this.city}\nState: ${this.state}\nZipCode: ${this.zipCode}\nPhone Number: ${this.phoneNumber}\nEmail-Id: ${this.emailId}\n************`;
    }
}
//uc3- Array to store objects
...
let getPhoneNumber = () =>{
    try{
        ...
        if(!phoneNumPattern.test(phoneNumber))
            throw 'Error!! PhoneNumber is not valid .. Eg. 91 9866666789';
        else
            return phoneNumber;
    }
    catch(e){
...
//uc4 - method to add details into object
let ValidateAndAdd = () =>{
    try{
        //FirstName
        while(true){
